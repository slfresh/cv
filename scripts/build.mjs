...
const locales = {
  de: {
    ...
    endLead: "Interesse? Schreiben Sie mir – ich melde mich schnell zurück.",
    hudHint: "Scrollen bewegt die Blätter",
    heroFigCaption: "Abb. 1 · Spule mit Magnetfeld · 3D in Echtzeit",
  ...
  en: {
    ...
    endLead: "Interested? Write to me – I will get back to you quickly.",
    hudHint: "Scrolling moves the sheets",
    heroFigCaption: "Fig. 1 · Coil with magnetic field · real-time 3D",
