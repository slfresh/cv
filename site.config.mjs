// Single place for site-wide settings. Everything that may change later lives here.

// Public e-mail address shown on the site. It is written into the HTML in reversed
